...
class GroupChat:
    ...
    Respond with ONLY the name of the speaker and DO NOT provide a reason."""
    select_speaker_transform_messages: Any = None
    ...
    def _prepare_and_select_agents(
        self,
        last_speaker: Agent,
    ) -> tuple[Agent | None, list[Agent], list[dict]]:
    ...
    def _auto_select_speaker(
        ...
        Args:
            ...
            agents list[Agent] | None: Valid list of agents for speaker selection
        ...
        def validate_speaker_name(recipient, messages, sender, config) -> tuple[bool, str | dict | None]:
    ...
    def _validate_speaker_name(
        self, recipient, messages: list[dict[str, str]], sender, config, attempts_left, attempt, agents
    ...
    def _participant_roles(self, agents: list["Agent"] | None = None) -> str:
...
class GroupChatManager(ConversableAgent):
    ...
    def _process_resume_termination(
        self, remove_termination_string: str | Callable[[str], str], messages: list[dict]
    ):
